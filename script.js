...
function onLoad() {
  console.log('hi');
  var li_3 = document.getElementsByClassName('selected').value;
  console.log(li_3);

  let inputValue = document.getElementsByClassName('selected').innerHTML;
  document.getElementById('valueInput').innerHTML = inputValue;

  function seleccionar_padre() {
    var hijo = document.getElementsByClassName('selected');
